...
function createApp() {
  ...
  const commonMigrations = [
    ...
    'CREATE INDEX IF NOT EXISTS idx_entity_files_type_id ON entity_files(entity_type, entity_id, id ASC);',
    'ALTER TABLE poles ADD COLUMN IF NOT EXISTS image_url_1 TEXT;',
    'ALTER TABLE poles ADD COLUMN IF NOT EXISTS image_url_2 TEXT;',
    'ALTER TABLE poles ADD COLUMN IF NOT EXISTS remarks TEXT;',
    'ALTER TABLE switch_points ADD COLUMN IF NOT EXISTS remarks TEXT;',
    'ALTER TABLE tgpl2_poles ADD COLUMN IF NOT EXISTS remarks TEXT;',
  ...
  const tgplMigrations = [
    ...
    `CREATE TABLE IF NOT EXISTS tgpl_installations (
      id SERIAL PRIMARY KEY,
      project_id INT NOT NULL DEFAULT 3,
      ward_id INT NOT NULL,
      ward_number VARCHAR(255),
      ccms_number VARCHAR(255) NOT NULL,
      pole_number VARCHAR(255) NOT NULL,
      pole_type VARCHAR(100) NOT NULL,
      how_many_lights_in_pole VARCHAR(10) DEFAULT '0',
      light_type VARCHAR(100),
      light_wattage VARCHAR(50),
      light_status VARCHAR(50),
      arm_status VARCHAR(50),
      light_type_2 VARCHAR(100),
      light_wattage_2 VARCHAR(50),
      light_status_2 VARCHAR(50),
      arm_status_2 VARCHAR(50),
      light_type_3 VARCHAR(100),
      light_wattage_3 VARCHAR(50),
      light_status_3 VARCHAR(50),
      arm_status_3 VARCHAR(50),
      light_type_4 VARCHAR(100),
      light_wattage_4 VARCHAR(50),
      light_status_4 VARCHAR(50),
      arm_status_4 VARCHAR(50),
      light_type_5 VARCHAR(100),
      ...
      deleted_by INT,
      offline_submission_id VARCHAR(255)
    );`,
    'CREATE INDEX IF NOT EXISTS idx_tgpl_inst_project_ward ON tgpl_installations(project_id, ward_id);',
    'CREATE INDEX IF NOT EXISTS idx_tgpl_inst_ccms ON tgpl_installations(ccms_number);',
