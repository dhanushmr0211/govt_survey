  ...
  try {
    ...
    if (shouldIncludePoles) {
      ...
      pSheet.columns = [
        ...
        { header: 'Light 6 Type', key: 'light_type_6', width: 15 },
        { header: 'Light 6 Capacity', key: 'light_capacity_6', width: 15 },
    ...
    if (shouldIncludeInst) {
      ...
      iSheet.columns = [
        ...
        { header: 'Light 6 Type', key: 'light_type_6', width: 15 },
        { header: 'Light 6 Wattage', key: 'light_capacity_6', width: 15 },
