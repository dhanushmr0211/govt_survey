...
async function createSwitchPoint(rawData) {
  ...
  const result = await query(
    `INSERT INTO switch_points
      (project_id, ulb_id, ward_number, switch_point_number, latitude, longitude, switch_point_type, meter_exists, meter_type, meter_rr_number, meter_serial_number, meter_condition, created_by, offline_submission_id, remarks)
