...
async function createPole(rawData) {
  ...
  const isTgpl = dbStorage.getStore() === tgplPool || String(data.project_id) === '3' || Number(data.project_id) === 3;
  if (isTgpl) {
