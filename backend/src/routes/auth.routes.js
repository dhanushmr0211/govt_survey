...
const { register, login, me, listUsers, getUserProjects, updateAccess, changePassword, uploadAvatar, deleteAvatar, assignUserProjects } = require('../controllers/authController');
...
authRouter.post('/users/:id/projects', authenticate, assignUserProjects);
